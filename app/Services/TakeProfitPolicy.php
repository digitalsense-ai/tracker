...
class TakeProfitPolicy
{
     ...
     * 2. Strategy profile settings[management]
     * 3. Daily plan item fields
     * 4. Global config defaults
     */
    public static function resolve(?Position $position = null, ?StrategyProfile $profile = null, array $planItem = []): array
    {
